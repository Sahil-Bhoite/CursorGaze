...
class EyeData:
    """
    Contains all data needed for Cursor Gaze model inference.
    
    This is the output of eye extraction and input to Cursor Gaze.
    """
...
class FacePredictor(ABC):
    ...
    def list_eye_data(
        ...
        """
        Detect faces and extract eye data for Cursor Gaze.
...
class DlibFacePredictor(FacePredictor):
    ...
    def _extract_eye_data(
        ...
        """Extract eye regions for Cursor Gaze."""
